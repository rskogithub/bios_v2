...
$string .= "\n\t    );
    ...
    public function cek(\$noreg)
    {
        \$row = \$this->" . $m . "->get_by_id(\$noreg);
...
$string .= "\n\t    );
            ...
            redirect(site_url('$c_url/create/'.\$noreg));
        }
    }
...
$string .= "\n\t    );
            ...
            <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\">
                <span aria-hidden=\"true\"><i class=\"fal fa-times\"></i></span>
            </button><strong> $tombol berhasil disimpan</strong></div>');
            redirect(site_url('rajal/read/'.\$this->input->post('noreg')));
        //}
    }
...
$string .= "\n\t    );
            ...
            <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\">
                <span aria-hidden=\"true\"><i class=\"fal fa-times\"></i></span>
            </button><strong>  $tombol berhasil diperbarui</strong></div>');
            redirect(site_url('rajal/read/'.\$this->input->post('noreg')));
        // }
    }
