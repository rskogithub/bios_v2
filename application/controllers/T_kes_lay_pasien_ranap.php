...
class T_kes_lay_pasien_ranap extends CI_Controller
{
    ...
    {
        $data = array(
            'data' => $this->T_kes_lay_pasien_ranap_model->get_all(),
        );
        $this->template->load('template', 't_kes_lay_pasien_ranap/t_kes_lay_pasien_ranap_list', $data);
    }
    ...
    public function update($tgl_transaksi, $kode_kelas)
    {
        $row = $this->T_kes_lay_pasien_ranap_model->get_by_id($tgl_transaksi, $kode_kelas);
