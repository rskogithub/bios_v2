...
class T_kes_sdm_nutritionist extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        is_login();
        $this->load->model('T_kes_sdm_nutritionist_model');
    ...
    public function json()
    {
        ...
        echo $this->T_kes_sdm_nutritionist_model->json();
    }

    public function read($id)
    {
        $row = $this->T_kes_sdm_nutritionist_model->get_by_id($id);
        if ($row) {
            $data = array(
                'id' => $row->id,
            ...
            $this->template->load('template', 't_kes_sdm_nutritionist/t_kes_sdm_nutritionist_read', $data);
        } else {
    ...
    public function create()
    {
        ...
        $this->template->load('template', 't_kes_sdm_nutritionist/t_kes_sdm_nutritionist_form', $data);
    }
    ...
    public function create_action()
    {
        ...
        $row = $this->T_kes_sdm_nutritionist_model->get_by_param($tanggal);
        if (($tanggal == $row->tgl_transaksi)) {
            $this->T_kes_sdm_nutritionist_model->update_kes_sdm_nutritionist($data);
        } else {
            $this->T_kes_sdm_nutritionist_model->insert_kes_sdm_nutritionist($data);
        }
    }
    ...
    public function update($id)
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('t_kes_sdm_nutritionist/update_action'),
    ...
    public function update_action()
    {
        ...
        $this->T_kes_sdm_nutritionist_model->update($this->input->post('id', TRUE), $data);
    ...
    public function delete($id)
    {
        ...
        if ($row) {
            $this->T_kes_sdm_nutritionist_model->delete($id);
...
/* End of file T_kes_sdm_nutritionist.php */