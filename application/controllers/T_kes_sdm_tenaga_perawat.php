...
class T_kes_sdm_tenaga_perawat extends CI_Controller
{
    ...
    {
        $this->template->load('template', 't_kes_sdm_tenaga_perawat/t_kes_sdm_tenaga_perawat_list');
    }
    ...
    public function update_action()
    {
        ...
        $this->T_kes_sdm_tenaga_perawat_model->update($this->input->post('id', TRUE), $data);
