...
class T_kes_ikt_kepatuhan_identifikasi_pasien extends CI_Controller
{
    ...
    {
        $this->template->load('template', 't_kes_ikt_kepatuhan_identifikasi_pasien/t_kes_ikt_kepatuhan_identifikasi_pasien_list');
    }
    ...
    public function update_action()
    {
        ...
        $this->T_kes_ikt_kepatuhan_identifikasi_pasien_model->update($this->input->post('id', TRUE), $data);
