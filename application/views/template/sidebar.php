<aside class="page-sidebar">
    <div class="page-logo">
        <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
            <img src="<?php echo base_url() ?>assets/smartadmin/img/logo_rsko2.jpg" alt="SmartAdmin WebApp" aria-roledescription="logo">
            <span class="page-logo-text mr-1">BIOS RSKO</span>
    ...
    <nav id="js-primary-nav" class="primary-nav" role="navigation">
        ...
        <div class="info-card">
            ...
            <div class="info-card-text">
                ...
                <span class="d-inline-block text-truncate text-truncate-sm"><?php echo $this->session->userdata('nama'); ?></span>
            </div>
        ...
        <ul id="js-nav-menu" class="nav-menu">
            ...
            if ($setting['value'] == 'ya') {
                ...
                $sql_menu = "SELECT *
            FROM tbl_menu
            WHERE id_menu in(select id_menu from tbl_hak_akses where id_user_level=$id_user_level) and is_main_menu=0 and is_aktif='y' and group_menu='simrs' order by title ASC";
            } else {
                $sql_menu = "select * from tbl_menu where is_aktif='y' and is_main_menu=0 and group_menu='simrs' order by title ASC";
            }
