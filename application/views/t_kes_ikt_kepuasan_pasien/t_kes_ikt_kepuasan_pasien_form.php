    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>INPUT DATA IKT - KEPUASAN PASIEN</h2>
                            ...
                            <table class='table table-striped'>
                                ...
                                <tr>
                                    ...
                                    <td><input type="hidden" name="id" value="<?php echo $id; ?>" />
                                        ...
                                        <a href="<?php echo site_url('t_kes_ikt_kepuasan_pasien') ?>" class="btn btn-info waves-effect waves-themed"><i class="fal fa-sign-out"></i> Kembali</a>
                                    </td>
                                </tr>
                            </table>
                        </form>
