    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>INPUT DATA SDM - TENAGA NON MEDIS</h2>
                    ...
                    <div class="panel-content">
                            ...
                            <table class='table table-striped'>
                                ...
                                <tr>
                                    ...
                                    <td><input type="hidden" name="id" value="<?php echo $id; ?>" />
                                        ...
                                        <a href="<?php echo site_url('t_kes_sdm_tenaga_non_medis') ?>" class="btn btn-info waves-effect waves-themed"><i class="fal fa-sign-out"></i> Kembali</a>
                                    </td>
                                </tr>
                            </table>
                        </form>
                        <div>
                            <p style="margin-bottom: 0px; color:red;">
                                - Data yang dikirimkan merupakan posisi data pada saat tanggal berkenaan, bersifat akumulatif. Data yang dikirimkan merupakan jumlah pegawai sesuai kriteria.
                            </p>
                            <p style="margin-bottom: 0px; color:red;">
                                - Data awal dikirimkan pada awal tahun berkenaan, updating data dikirimkan per periode semesteran/tahunan.
                            </p>
                            <p style="margin-bottom: 0px; color:red;">
                                - Data yang dikirimkan sesuai dengan klasifikasi pada dokumen RL.2 Juknis SIMRS.
                            </p>
                        </div>
                    </div>
                </div>
