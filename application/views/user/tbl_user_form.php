                        ...
                        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                            ...
                            <table class='table table-bordered'>
                                ...
                                if ($this->uri->segment(2) == 'create') {
                                    ?>
                                    <tr>
                                        <td width='200'>Pegawai <?php echo form_error('id_pegawai') ?></td>
                                        <td><?php echo select2_dinamis('id_pegawai', 'zx_v_pegawai_user', 'id_pegawai', 'nama', $id_pegawai, 'aktif=0 and id_users is null', 'nama ASC') ?></td>
                                    </tr>
                                <?php } else { ?>
                                    <tr>
                                        <td width='200'>Pegawai</td>
                                        <td><?php echo $nama ?><input type="hidden" name="id_pegawai" value="<?php echo $id_pegawai; ?>" /></td>
                                    </tr>
                                <?php
                                }
                                ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo cmb_dinamis('id_user_level', 'zx_tbl_user_level', 'id_user_level', 'nama_level', $id_user_level, '', 'id_user_level DESC') ?>
