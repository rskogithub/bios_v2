...
<div class="row">
    <div class="col-xl-12">
	    ...
	    <tr><td>Alos</td><td><?php echo $alos; ?></td></tr>
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('t_kes_lay_alos') ?>" class="btn btn-primary waves-effect waves-themed">Kembali</a></td></tr>
	</table>
</div>
</div>
