...
<div class="row">
    <div class="col-xl-12">
	    ...
	    <tr><td>Toi</td><td><?php echo $toi; ?></td></tr>
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('t_kes_lay_toi') ?>" class="btn btn-primary waves-effect waves-themed">Kembali</a></td></tr>
	</table>
</div>
</div>
