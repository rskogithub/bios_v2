...
<body class="nav-function-top header-function-fixed nav-function-fixed mod-pace-custom mod-bg-1 desktop chrome webkit pace-done nav-mobile-push nav-mobile-no-overlay blur">
    ...
    <div class="page-wrapper">
            ...
            <div class="page-content-wrapper">
                ...
                <header class="page-header" role="banner">
                    ...
                    <div class="ml-auto d-flex">
                        ...
                        <!-- app notification -->
                        <div>
                            <a href="#" class="header-icon" data-toggle="dropdown" title="Notifikasi Obat">
                                <span class="fal fa-capsules mr-1"></span>
                            ...
                            <div class="dropdown-menu dropdown-menu-animated dropdown-xl">
                                ...
                                <ul class="nav nav-tabs nav-tabs-clean nav-justified" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link px-4 fs-md js-waves-on fw-500" data-toggle="tab" href="#tab-farmasi" data-i18n="drpdwn.messages">Stok Farmasi</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link px-4 fs-md js-waves-on fw-500" data-toggle="tab" href="#tab-apotik" data-i18n="drpdwn.feeds">Stok Apotik</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link px-4 fs-md js-waves-on fw-500" data-toggle="tab" href="#tab-expired" data-i18n="drpdwn.events">Expired</a>
                                    </li>
                                </ul>
                                <div class="tab-content tab-notification">
                                    ...
                                    <!-- <div class="tab-pane" id="tab-farmasi" role="tabpanel">
                                        <div class="custom-scroll h-100">
                                            <ul class="notification">
                                                <?php
                                                $this->db->where('sisa <', '30');
                                                $rows = $this->db->get('zx_v_obat_farmasi')->result();
                                                foreach ($rows as $row) { ?>
                                                    <li class="unread">
                                                        <a href="#" class="d-flex align-items-center">
                                                            <span class="d-flex flex-column flex-1 ml-1">
                                                                <span class="name"><?php echo $row->nama_obat ?> <span class="badge badge-primary fw-n position-absolute pos-top pos-right mt-1"><?php echo $row->sisa ?></span></span>
                                                                <span class="msg-a fs-sm">
                                                                    <span class="badge badge-success"><?php echo $row->kategori ?></span>
                                                                    <span class="badge badge-success"><?php echo $row->jenis_obat ?></span>
                                                                    <span class="badge badge-success"><?php echo $row->satuan ?></span>
                                                                </span>
                                                            </span>
                                                        </a>
                                                    </li>
                                    ...
                                    <!-- <div class="tab-pane" id="tab-apotik" role="tabpanel">
                                        <div class="custom-scroll h-100">
                                            <ul class="notification">
                                                <?php
                                                $this->db->where('sisa <', '30');
                                                $rows = $this->db->get('zx_v_obat_layanan')->result();
                                                foreach ($rows as $row) { ?>
                                                    <li class="unread">
                                                        <a href="#" class="d-flex align-items-center">
                                                            <span class="d-flex flex-column flex-1 ml-1">
                                    ...
                                    <!-- <div class="tab-pane" id="tab-expired" role="tabpanel">
                                        <div class="custom-scroll h-100">
                                            <ul class="notification">
                                                <?php
                                                $this->db->where('expired_day <', 0);
                                                $this->db->where('expired_day >=', -30);
                                                $rows = $this->db->get('zx_v_obat_farmasi_detail')->result();
                                                foreach ($rows as $row) { ?>
                                                    <li class="unread">
                                                        <a href="#" class="d-flex align-items-center">
                                                            <span class="d-flex flex-column flex-1 ml-1">
                                                                <span class="name"><?php echo kapital($row->nama_obat) ?></span>
                                                                <span class="msg-a fs-sm">
                                                                    <span class="badge badge-success"><?php echo $row->kategori ?></span>
                                                                    <!-- <span class="badge badge-success"><?php echo $row->jenis_obat ?></span> -->
                                    <span class="badge badge-success"><?php echo $row->satuan ?></span>
                                    <?php
                                                    if ($row->expired_day > 0) {
                                                        echo '<span class="badge badge-secondary">expired</span>';
                                                    } else {
                                                        $nilai = abs($row->expired_day);
                                                        if (($nilai > 0) && ($nilai <= 30)) {
                                                            echo '<span class="badge badge-warning">Expired ' . $nilai . ' hari</span>';
                                                        } else {
                                                        }
                                                    }
                                    ?>
                    ...
                    <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                        <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                            ...
                            <div class="info-card-text">
                                ...
                                <span class="text-truncate text-truncate-md opacity-80"><?php echo $this->session->userdata('nama'); ?></span>
                                <span class="text-truncate text-truncate-md opacity-80">NIP. <?php echo $this->session->userdata('nip'); ?></span>
                            </div>
                        </div>
        ...
        <footer class="page-footer" role="contentinfo">
            <div class="d-flex align-items-center flex-1 text-muted">
                <span class="hidden-md-down fw-700">2021 © SIMRSRSKO
