                            ...
                            <tbody><?php $start = 0;
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center">
                                            <?php
                                            echo anchor(site_url('t_kes_ikt_kepatuhan_identifikasi_pasien/update/' . $row['tgl_transaksi']), '<i class="fal fa-pencil" aria-hidden="true"></i>', 'class="btn btn-warning btn-xs waves-effect waves-themed"');
                                            ?>
                                        </td>
                                    </tr>
                                <?php
