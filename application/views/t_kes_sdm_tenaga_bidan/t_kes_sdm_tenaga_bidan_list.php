                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="text-align:center">
                                            <?php
                                            echo anchor(site_url('t_kes_sdm_tenaga_bidan/update/' . $row['tgl_transaksi']), '<i class="fal fa-pencil" aria-hidden="true"></i>', 'class="btn btn-warning btn-xs waves-effect waves-themed"');
                                            ?>
                                        </td>
                                    </tr>
                                <?php
