...
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>KELOLA DATA T_KES_SDM_TENAGA_BIDAN</h2>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#dt-basic-example").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "t_kes_sdm_tenaga_bidan/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id",
                            "orderable": false
                        },{"data": "tgl_transaksi"},{"data": "pns"},{"data": "pppk"},{"data": "anggota"},{"data": "non_pns_tetap"},{"data": "kontrak"},{"data": "message"},{"data": "user"},{"data": "create_date"},
                        {
                            "data" : "action",
                            "orderable": false,
