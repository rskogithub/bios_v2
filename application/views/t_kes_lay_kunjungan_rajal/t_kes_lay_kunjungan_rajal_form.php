                ...
                <div class="panel-container show">
                    <div class="panel-content">
                            ...
                            <table class='table table-striped'>
                                ...
                                <tr>
                                    ...
                                    <td><input type="hidden" name="id" value="<?php echo $id; ?>" />
                                        ...
                                        <a href="<?php echo site_url('t_kes_lay_kunjungan_rajal') ?>" class="btn btn-info waves-effect waves-themed"><i class="fal fa-sign-out"></i> Kembali</a>
                                    </td>
                                </tr>
                            </table>
                        </form>
                        <div>
                            ...
                            <p style="margin-bottom: 0px; color:red;">
                                - Data dikirimkan per periode harian. Data yang dikirimkan dari seluruh poli di dalam Rumah Sakit bersangkutan.
                            </p>
                        </div>
                    </div>
                </div>
