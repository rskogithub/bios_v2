...
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>KELOLA DATA RASIO OPTIMALISASI KAS</h2>
        ...
        <?php echo anchor(site_url('rasio_optimal_kas/create'), '<i class="fal fa-plus-square" aria-hidden="true"></i> Tambah Data', 'class="btn btn-primary btn-sm waves-effect waves-themed"'); ?>
		<?php echo anchor(site_url('rasio_optimal_kas/excel'), '<i class="fal fa-file-excel" aria-hidden="true"></i> Export Ms Excel', 'class="btn btn-outline-success btn-sm waves-effect waves-themed"'); ?></div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#dt-basic-example").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "rasio_optimal_kas/json", "type": "POST"},
                    columns: [
                        {
                            "data": "no_id",
                            "orderable": false
