...
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>T_kes_sdm_dokter_gigi Read</h2>
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('t_kes_sdm_dokter_gigi') ?>" class="btn btn-primary waves-effect waves-themed">Kembali</a></td></tr>
	</table>
</div>
</div>
