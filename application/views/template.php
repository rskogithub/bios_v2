...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo base_url() ?>assets/smartadmin/img/favicon/favicon.png">
    ...
    <link id="mytheme" rel="stylesheet" href="<?php echo base_url() ?>assets/smartadmin/css/themes/cust-theme-10.css">
    <!--<link rel="stylesheet" media="screen, print" href="css/your_styles.css">-->
</head>

<body class="mod-bg-1 nav-function-top header-function-fixed nav-function-fixed mobile chrome webkit no-slimscroll pace-done modal-open mod-pace-custom blur">
