...
class T_kes_lay_kunjungan_rajal_model extends CI_Model
{

    public $table = 't_kes_lay_kunjungan_rajal';
    public $id = 'id';
    public $order = 'DESC';
    ...
    function update_kes_lay_kunjungan_rajal($data)
    {
        $response = $this->_client->request('POST', 'kesehatan/layanan/pasien_ralan', [
            'form_params' => $data
        ]);
    ...
    function json()
    {
        ...
        $this->datatables->from('t_kes_lay_kunjungan_rajal');
        //add this line for join
        //$this->datatables->join('table2', 't_kes_lay_kunjungan_rajal.field = table2.field');
        // $this->datatables->add_column('action', anchor(site_url('t_kes_lay_kunjungan_rajal/read/$1'), '<i class="fal fa-eye" aria-hidden="true"></i>', array('class' => 'btn btn-info btn-xs')) . "
        //     " . anchor(site_url('t_kes_lay_kunjungan_rajal/update/$1'), '<i class="fal fa-pencil" aria-hidden="true"></i>', array('class' => 'btn btn-warning btn-xs')) . "
        //         " . anchor(site_url('t_kes_lay_kunjungan_rajal/delete/$1'), '<i class="fal fa-trash" aria-hidden="true"></i>', 'class="btn btn-danger btn-xs" onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id');
...
/* End of file T_kes_lay_kunjungan_rajal_model.php */
/* Location: ./application/models/T_kes_lay_kunjungan_rajal_model.php */
/* Please DO NOT modify this information : */
/* Generated by Harviacode Codeigniter CRUD Generator 2023-04-12 08:19:12 */
/* http://harviacode.com */