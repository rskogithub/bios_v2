...
class T_kes_lay_pasien_igd_model extends CI_Model
{

    public $table = 't_kes_lay_pasien_igd';
    public $id = 'id';
    public $order = 'DESC';
    ...
    function update_kes_lay_pasien_igd($data)
    {
        $response = $this->_client->request('POST', 'kesehatan/layanan/pasien_igd', [
            'form_params' => $data
        ]);
    ...
    function get_all()
    {
        ...
        $response = $this->_client->request('POST', 'https://bios.kemenkeu.go.id/api/get/data/kesehatan/layanan/pasien_igd', [
            // 'debug' => true,
            'form_params' => $data
        ]);
        $result = json_decode($response->getBody()->getContents(), true);
    ...
    function json()
    {
        ...
        $this->datatables->from('t_kes_lay_pasien_igd');
        //add this line for join
        //$this->datatables->join('table2', 't_kes_lay_pasien_igd.field = table2.field');
        // $this->datatables->add_column('action', anchor(site_url('t_kes_lay_pasien_igd/read/$1'), '<i class="fal fa-eye" aria-hidden="true"></i>', array('class' => 'btn btn-info btn-xs')) . "
...
/* End of file T_kes_lay_pasien_igd_model.php */
/* Location: ./application/models/T_kes_lay_pasien_igd_model.php */
/* Please DO NOT modify this information : */
/* Generated by Harviacode Codeigniter CRUD Generator 2023-04-12 08:23:27 */
/* http://harviacode.com */