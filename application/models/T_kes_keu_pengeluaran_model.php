...
class T_kes_keu_pengeluaran_model extends CI_Model
{

    public $table = 't_kes_keu_pengeluaran';
    public $id = 'id';
    public $order = 'DESC';
    ...
    function insert_kes_keu_pengeluaran($data)
    {
        $response = $this->_client->request('POST', 'keuangan/akuntansi/pengeluaran', [
            'form_params' => $data
        ]);
        $result = json_decode($response->getBody()->getContents(), true);
        $return_data = array(
    ...
    function update_kes_keu_pengeluaran($data)
    {
        $response = $this->_client->request('POST', 'keuangan/akuntansi/pengeluaran', [
            'form_params' => $data
        ]);
    ...
    function json()
    {
        $this->datatables->select('id,tgl_transaksi,kd_akun,jumlah,message,user,create_date');
        $this->datatables->from('t_kes_keu_pengeluaran');
        //add this line for join
        //$this->datatables->join('table2', 't_kes_keu_pengeluaran.field = table2.field');
        $this->datatables->add_column('action', anchor(site_url('t_kes_keu_pengeluaran/read/$1'), '<i class="fal fa-eye" aria-hidden="true"></i>', array('class' => 'btn btn-info btn-xs')) . "
...
/* End of file T_kes_keu_pengeluaran_model.php */
/* Location: ./application/models/T_kes_keu_pengeluaran_model.php */
/* Please DO NOT modify this information : */
/* Generated by Harviacode Codeigniter CRUD Generator 2023-04-04 08:20:14 */
/* http://harviacode.com */