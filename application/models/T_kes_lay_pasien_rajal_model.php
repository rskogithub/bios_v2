...
class T_kes_lay_pasien_rajal_model extends CI_Model
{
    ...
    function update_kes_lay_pasien_rajal($data)
    {
        $response = $this->_client->request('POST', 'kesehatan/layanan/pasien_ralan_poli', [
            'form_params' => $data
        ]);
        ...
        // print_r($result);
        if ($result['status'] == 'MSG20003') {
            $this->db->where('nama_poli', $data['nama_poli']);
    ...
    function get_by_param($tgl_transaksi, $nama_poli)
    {
    ...
    function json()
    {
        $this->datatables->select('id,tgl_transaksi,nama_poli,jumlah,message,user,create_date');
        $this->datatables->from('t_kes_lay_pasien_rajal');
        //add this line for join
        //$this->datatables->join('table2', 't_kes_lay_pasien_rajal.field = table2.field');
        // $this->datatables->add_column('action', anchor(site_url('t_kes_lay_pasien_rajal/read/$1'),'<i class="fal fa-eye" aria-hidden="true"></i>', array('class' => 'btn btn-info btn-xs'))."
        //     ".anchor(site_url('t_kes_lay_pasien_rajal/update/$1'),'<i class="fal fa-pencil" aria-hidden="true"></i>', array('class' => 'btn btn-warning btn-xs'))."
        //         ".anchor(site_url('t_kes_lay_pasien_rajal/delete/$1'),'<i class="fal fa-trash" aria-hidden="true"></i>','class="btn btn-danger btn-xs" onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id');
